        ...
        <div className="min-h-screen p-8" style={{ backgroundColor: '#edf1fc' }}>
            <div className="max-w-4xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    <h1 className="text-2xl text-black" style={{ color: '#ED0F35' }}>Terms of Use</h1>
                    <Button
                        variant="ghost"
                ...
                <div className="space-y-6">
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>Acceptance of Terms</h2>
                    ...
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>Services Description</h2>
                        <div className="space-y-4">
                            <div>
                                <h3 className="text-lg mb-2" style={{ color: '#ED0F35' }}>Microsoft 365 Tenant Services</h3>
                                <p className="text-gray-700">
                            ...
                            <div>
                                <h3 className="text-lg mb-2" style={{ color: '#ED0F35' }}>Custom Websites and Applications</h3>
                                <p className="text-gray-700">
                    ...
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>User Responsibilities</h2>
                    ...
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>Data Usage and Access</h2>
                        <div className="space-y-4">
                            <div>
                                <h3 className="text-lg mb-2" style={{ color: '#ED0F35' }}>Microsoft 365 Data</h3>
                                <p className="text-gray-700">
                            ...
                            <div>
                                <h3 className="text-lg mb-2" style={{ color: '#ED0F35' }}>Custom Website Data</h3>
                                <p className="text-gray-700">
                    ...
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>Prohibited Activities</h2>
                        <div className="text-gray-700 space-y-2">
                    ...
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>Intellectual Property</h2>
                        <p className="text-gray-700">
                    ...
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>Service Availability</h2>
                        <p className="text-gray-700">
                    ...
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>Limitation of Liability</h2>
                        <p className="text-gray-700">
                    ...
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>Termination</h2>
                        <p className="text-gray-700">
                    ...
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>Changes to Terms</h2>
                        <p className="text-gray-700">
                    ...
                    <section>
                        <h2 className="text-xl mb-4" style={{ color: '#ED0F35' }}>Contact Information</h2>
                        <p className="text-gray-700">
